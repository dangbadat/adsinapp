...
import com.sdk.ads.glide.load.engine.bitmap_recycle.BitmapPoolAdapter;
import com.sdk.ads.glide.load.engine.bitmap_recycle.LruArrayPool;
import com.sdk.ads.glide.load.engine.bitmap_recycle.LruBitmapPool;
import com.sdk.ads.glide.load.engine.cache.DiskCache;
import com.sdk.ads.glide.load.engine.cache.InternalCacheDiskCacheFactory;
import com.sdk.ads.glide.load.engine.cache.LruResourceCache;
import com.sdk.ads.glide.load.engine.cache.MemoryCache;
import com.sdk.ads.glide.load.engine.cache.MemorySizeCalculator;
import com.sdk.ads.glide.load.engine.executor.GlideExecutor;
import com.sdk.ads.glide.manager.ConnectivityMonitorFactory;
import com.sdk.ads.glide.manager.DefaultConnectivityMonitorFactory;
import com.sdk.ads.glide.manager.RequestManagerRetriever;
import com.sdk.ads.glide.manager.RequestManagerRetriever.RequestManagerFactory;
...
public final class GlideBuilder {
   ...
   * {@link com.sdk.ads.glide.load.engine.Resource}s that are not currently in use.
   *
   ...
   * com.sdk.ads.glide.load.engine.Resource} data on disk.
   *
   ...
   * {@link com.sdk.ads.glide.load.engine.Resource}s that are not already in the cache.
   *
  ...
  /**
   * Sets the {@link GlideExecutor} to use when retrieving
   * {@link com.sdk.ads.glide.load.engine.Resource}s that are currently in Glide's disk caches.
   *
   ...
   * of {@link com.sdk.ads.glide.load.resource.gif.GifDrawable}s.
   *
   ...
   * {@link com.sdk.ads.glide.load.resource.gif.GifDrawable} or
   ...
   * to use to notify {@link com.sdk.ads.glide.RequestManager} of connectivity events.
   * If not set {@link com.sdk.ads.glide.manager.DefaultConnectivityMonitorFactory} would be used.
   *
   ...
   * {@link com.sdk.ads.glide.load.engine.GlideException#setOrigin(Exception)} for failed requests.
   *
  ...
  @NonNull
  com.sdk.ads.glide.Glide build(@NonNull Context context) {
