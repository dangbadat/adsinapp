...
import com.sdk.ads.glide.load.ImageHeaderParser.ImageType;
import com.sdk.ads.glide.load.ImageHeaderParserUtils;
...
import com.sdk.ads.glide.load.resource.bitmap.DownsampleStrategy.SampleSizeRounding;
...
public final class Downsampler {
  ...
  public static final Option<DecodeFormat> DECODE_FORMAT = Option.memory(
      "com.sdk.ads.glide.load.resource.bitmap.Downsampler.DecodeFormat", DecodeFormat.DEFAULT);
  /**
   * Indicates the {@link com.sdk.ads.glide.load.resource.bitmap.DownsampleStrategy} option that
  ...
  public static final Option<Boolean> FIX_BITMAP_SIZE_TO_REQUESTED_DIMENSIONS =
      Option.memory("com.sdk.ads.glide.load.resource.bitmap.Downsampler.FixBitmapSize", false);
   ...
   * {@link com.sdk.ads.glide.GlideBuilder#setDefaultRequestOptions(RequestOptions)}.
   *
   * <p>This option is ignored unless we're on Android O+.
   */
  public static final Option<Boolean> ALLOW_HARDWARE_CONFIG =
      Option.memory(
          "com.sdk.ads.glide.load.resource.bitmap.Downsampler.AllowHardwareDecode", false);
   ...
   * provided  {@link com.sdk.ads.glide.load.resource.bitmap.DownsampleStrategy} option.
   *
