...
/**
 * A coordinator that coordinates two individual {@link com.sdk.ads.glide.request.Request}s that load a small thumbnail
 * version of an image and the full size version of the image at the same time.
 */
public class ThumbnailRequestCoordinator implements com.sdk.ads.glide.request.RequestCoordinator,
        com.sdk.ads.glide.request.Request {
  @Nullable private final com.sdk.ads.glide.request.RequestCoordinator parent;

  private com.sdk.ads.glide.request.Request full;
  private com.sdk.ads.glide.request.Request thumb;
  ...
  public void setRequests(com.sdk.ads.glide.request.Request full, com.sdk.ads.glide.request.Request thumb) {
    this.full = full;
    this.thumb = thumb;
  }
  ...
  @Override
  public void onRequestFailed(com.sdk.ads.glide.request.Request request) {
