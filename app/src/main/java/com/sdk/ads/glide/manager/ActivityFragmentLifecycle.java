...
class ActivityFragmentLifecycle implements Lifecycle {
  private final Set<com.sdk.ads.glide.manager.LifecycleListener> lifecycleListeners =
      Collections.newSetFromMap(new WeakHashMap<com.sdk.ads.glide.manager.LifecycleListener, Boolean>());
   ...
   * method. If the activity or fragment is stopped, {@link com.sdk.ads.glide.manager.LifecycleListener#onStop()}} will be
   * called, and same for onStart and onDestroy. </p>
   *
   * <p> Note - {@link com.sdk.ads.glide.manager.LifecycleListener}s that are added more than once
  ...
  @Override
  public void removeListener(@NonNull com.sdk.ads.glide.manager.LifecycleListener listener) {
    lifecycleListeners.remove(listener);
  }

  void onStart() {
    isStarted = true;
    for (com.sdk.ads.glide.manager.LifecycleListener lifecycleListener : Util.getSnapshot(lifecycleListeners)) {
