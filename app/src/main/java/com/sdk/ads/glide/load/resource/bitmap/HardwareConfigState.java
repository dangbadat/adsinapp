...
final class HardwareConfigState {
   ...
   * and/or a sufficiently large {@link com.sdk.ads.glide.load.engine.cache.MemoryCache}, we can
   ...
   * hardware Bitmaps.
   *
   * <p>Reduced on S7 Edge devices due to  https://github.com.sdk.ads/glide/issues/3275.
   */
  ...
  private synchronized boolean isFdSizeBelowHardwareLimit() {
    if (++decodesSinceLastFdCheck >= MINIMUM_DECODES_BETWEEN_FD_CHECKS) {
      ...
      if (!isHardwareConfigAllowed && Log.isLoggable(com.sdk.ads.glide.load.resource.bitmap.Downsampler.TAG, Log.WARN)) {
