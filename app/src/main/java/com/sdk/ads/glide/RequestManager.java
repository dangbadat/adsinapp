...
import static com.sdk.ads.glide.request.RequestOptions.decodeTypeOf;
...
import com.sdk.ads.glide.manager.RequestTracker;
import com.sdk.ads.glide.manager.TargetTracker;
...
import com.sdk.ads.glide.request.transition.Transition;
 ...
 *
 * @see com.sdk.ads.glide.Glide#with(android.app.Activity)
 * @see com.sdk.ads.glide.Glide#with(android.support.v4.app.FragmentActivity)
 * @see com.sdk.ads.glide.Glide#with(android.app.Fragment)
 * @see com.sdk.ads.glide.Glide#with(android.support.v4.app.Fragment)
 * @see com.sdk.ads.glide.Glide#with(Context)
 */
...
//  private static final RequestOptions DECODE_TYPE_GIF = decodeTypeOf(GifDrawable.class).lock();
  ...
  protected final com.sdk.ads.glide.Glide glide;
  ...
  public RequestManager(
          @NonNull com.sdk.ads.glide.Glide glide, @NonNull Lifecycle lifecycle,
   ...
   * com.sdk.ads.glide.GlideBuilder#setDefaultRequestOptions(RequestOptions)}. If there are conflicts, the options
   * applied here will win. Note that this method does not mutate options provided to {@link
   * com.sdk.ads.glide.GlideBuilder#setDefaultRequestOptions(RequestOptions)}.
   *
...
//  }
   ...
   * com.sdk.ads.glide.load.ResourceDecoder}s that can decode any subclass of {@link Drawable}.
   *
   ...
   * {@link com.sdk.ads.glide.load.ResourceDecoder}s
