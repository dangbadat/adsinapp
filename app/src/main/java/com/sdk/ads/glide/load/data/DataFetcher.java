package com.sdk.ads.glide.load.data;
 ...
 *
 * <p> A new instance is
 * created per resource load by {@link com.sdk.ads.glide.load.model.ModelLoader}. {@link
 * #loadData(Priority, com.sdk.ads.glide.load.data.DataFetcher.DataCallback)}
 ...
 * com.sdk.ads.glide.load.data.DataFetcher.DataCallback)}} is called, then so {@link #cleanup()}
 * will be called. </p>
 *
...
public interface DataFetcher<T> {
   ...
   * com.sdk.ads.glide.load.data.DataFetcher.DataCallback)} has been decoded by the
   * {@link com.sdk.ads.glide.load.ResourceDecoder}.
   *
   * <p> Note - this method will be run on a background thread so blocking I/O is safe. </p>
   */
  void cleanup();
  ...
  /**
   * Returns the {@link com.sdk.ads.glide.load.DataSource} this fetcher will return data from.
   */
  @NonNull
