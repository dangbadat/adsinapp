 ...
 */
public class MultiTransformation<T> implements com.sdk.ads.glide.load.Transformation<T> {
  private final Collection<? extends com.sdk.ads.glide.load.Transformation<T>> transformations;

  @SafeVarargs
  @SuppressWarnings("varargs")
  public MultiTransformation(@NonNull com.sdk.ads.glide.load.Transformation<T>... transformations) {
  ...
  public MultiTransformation(@NonNull Collection<? extends com.sdk.ads.glide.load.Transformation<T>> transformationList) {
  ...
  public Resource<T> transform(
    ...
    for (com.sdk.ads.glide.load.Transformation<T> transformation : transformations) {
