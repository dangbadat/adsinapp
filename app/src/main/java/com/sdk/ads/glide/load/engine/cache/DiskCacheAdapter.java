 ...
 */
public class DiskCacheAdapter implements com.sdk.ads.glide.load.engine.cache.DiskCache {
  @Override
   ...
   */
  public static final class Factory implements com.sdk.ads.glide.load.engine.cache.DiskCache.Factory {
    @Override
