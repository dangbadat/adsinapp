...
import com.sdk.ads.glide.load.MultiTransformation;
import com.sdk.ads.glide.load.Option;
...
import com.sdk.ads.glide.load.resource.bitmap.CenterCrop;
import com.sdk.ads.glide.load.resource.bitmap.CenterInside;
import com.sdk.ads.glide.load.resource.bitmap.CircleCrop;
import com.sdk.ads.glide.load.resource.bitmap.DownsampleStrategy;
import com.sdk.ads.glide.load.resource.bitmap.Downsampler;
import com.sdk.ads.glide.load.resource.bitmap.DrawableTransformation;
import com.sdk.ads.glide.load.resource.bitmap.FitCenter;
import com.sdk.ads.glide.load.resource.bitmap.VideoDecoder;
import com.sdk.ads.glide.signature.EmptySignature;
import com.sdk.ads.glide.util.CachedHashCodeArrayMap;
 ...
 * {@link com.sdk.ads.glide.RequestBuilder}.
 *
...
public abstract class BaseRequestOptions<T extends BaseRequestOptions<T>> implements Cloneable {
  ...
  /**
   * Applies a multiplier to the {@link com.sdk.ads.glide.request.target.Target}'s size before
   ...
   *                       {@link com.sdk.ads.glide.request.target.Target}'s dimensions when
   ...
   * {@link com.sdk.ads.glide.RequestBuilder#load(Object)} is {@code null}.
   *
  ...
  /**
   * Overrides the {@link com.sdk.ads.glide.request.target.Target}'s width and height with the
   ...
   * @return This request builder.
   * @see com.sdk.ads.glide.signature.ObjectKey
   */
  @NonNull
  @CheckResult
   ...
   * {@link com.sdk.ads.glide.load.resource.bitmap.DownsampleStrategy.CenterOutside} can safely use
   ...
   * {@link com.sdk.ads.glide.load.model.stream.HttpGlideUrlLoader}. If you use any other
   * networking library including Glide's Volley or OkHttp integration libraries, this option will
   * be ignored.
   *
   * @see com.sdk.ads.glide.load.model.stream.HttpGlideUrlLoader#TIMEOUT
  ...
  /**
   * Applies {@link com.sdk.ads.glide.load.resource.bitmap.CenterInside} to all default types,
   ...
   * {@link com.sdk.ads.glide.TransitionOptions#dontTransition()}</p>
   */
  // Guaranteed to modify the current object by the isAutoCloneEnabledCheck.
  @SuppressWarnings("CheckResult")
//  @NonNull
