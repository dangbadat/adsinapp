...
final class PreFillQueue {
  ...
  private final Map<com.sdk.ads.glide.load.engine.prefill.PreFillType, Integer> bitmapsPerType;
  private final List<com.sdk.ads.glide.load.engine.prefill.PreFillType> keyList;
  private int bitmapsRemaining;
  private int keyIndex;

  public PreFillQueue(Map<com.sdk.ads.glide.load.engine.prefill.PreFillType, Integer> bitmapsPerType) {
  ...
  public com.sdk.ads.glide.load.engine.prefill.PreFillType remove() {
