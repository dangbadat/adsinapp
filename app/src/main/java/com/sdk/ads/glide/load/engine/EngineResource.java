 ...
 * com.sdk.ads.glide.load.engine.Resource} interface.
 *
 * @param <Z> The type of data returned by the wrapped {@link com.sdk.ads.glide.load.engine.Resource}.
 */
class EngineResource<Z> implements com.sdk.ads.glide.load.engine.Resource<Z> {
  private final boolean isMemoryCacheable;
  private final boolean isRecyclable;
  private final com.sdk.ads.glide.load.engine.Resource<Z> resource;
  ...
  EngineResource(
      com.sdk.ads.glide.load.engine.Resource<Z> toWrap,
