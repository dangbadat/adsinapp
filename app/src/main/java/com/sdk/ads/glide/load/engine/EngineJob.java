...
import com.sdk.ads.glide.load.engine.DecodeJob;
import com.sdk.ads.glide.load.engine.EngineJobListener;
import com.sdk.ads.glide.load.engine.EngineResource;
import com.sdk.ads.glide.load.engine.EngineResource.ResourceListener;
import com.sdk.ads.glide.load.engine.Resource;
import com.sdk.ads.glide.load.engine.executor.GlideExecutor;
import com.sdk.ads.glide.request.ResourceCallback;
 ...
 */
class EngineJob<R> implements com.sdk.ads.glide.load.engine.DecodeJob.Callback<R>,
    Poolable {
  ...
  private com.sdk.ads.glide.load.engine.Resource<?> resource;
  ...
  private com.sdk.ads.glide.load.engine.DecodeJob<R> decodeJob;
  ...
  public synchronized void start(com.sdk.ads.glide.load.engine.DecodeJob<R> decodeJob) {
  ...
  @Override
  public void onResourceReady(com.sdk.ads.glide.load.engine.Resource<R> resource, DataSource dataSource) {
    synchronized (this) {
  ...
  @Override
  public void reschedule(com.sdk.ads.glide.load.engine.DecodeJob<?> job) {
