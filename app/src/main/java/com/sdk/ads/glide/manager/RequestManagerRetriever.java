...
import com.sdk.ads.glide.manager.ApplicationLifecycle;
import com.sdk.ads.glide.manager.EmptyRequestManagerTreeNode;
import com.sdk.ads.glide.manager.Lifecycle;
import com.sdk.ads.glide.manager.RequestManagerFragment;
import com.sdk.ads.glide.manager.RequestManagerTreeNode;
import com.sdk.ads.glide.manager.SupportRequestManagerFragment;
...
public class RequestManagerRetriever implements Handler.Callback {
  @VisibleForTesting
  static final String FRAGMENT_TAG = "com.sdk.ads.glide.manager";
  ...
  @VisibleForTesting
  final Map<android.app.FragmentManager, com.sdk.ads.glide.manager.RequestManagerFragment> pendingRequestManagerFragments =
      new HashMap<>();
      ...
      synchronized (this) {
        if (applicationManager == null) {
          ...
          applicationManager =
              factory.build(
                  glide,
                  new com.sdk.ads.glide.manager.ApplicationLifecycle(),
  ...
  @Deprecated
  @NonNull
  com.sdk.ads.glide.manager.RequestManagerFragment getRequestManagerFragment(Activity activity) {
  ...
  @SuppressWarnings("deprecation")
  @NonNull
  private com.sdk.ads.glide.manager.RequestManagerFragment getRequestManagerFragment(
      @NonNull final android.app.FragmentManager fm,
      @Nullable android.app.Fragment parentHint,
      boolean isParentVisible) {
    com.sdk.ads.glide.manager.RequestManagerFragment current = (com.sdk.ads.glide.manager.RequestManagerFragment) fm.findFragmentByTag(FRAGMENT_TAG);
    if (current == null) {
      current = pendingRequestManagerFragments.get(fm);
      if (current == null) {
        current = new com.sdk.ads.glide.manager.RequestManagerFragment();
  ...
  public interface RequestManagerFactory {
    ...
    RequestManager build(
            @NonNull Glide glide,
            @NonNull com.sdk.ads.glide.manager.Lifecycle lifecycle,
            @NonNull com.sdk.ads.glide.manager.RequestManagerTreeNode requestManagerTreeNode,
            @NonNull Context context);
  }
