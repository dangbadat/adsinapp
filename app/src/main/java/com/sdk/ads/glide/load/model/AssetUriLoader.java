...
import com.sdk.ads.glide.load.data.FileDescriptorAssetPathFetcher;
import com.sdk.ads.glide.load.data.StreamAssetPathFetcher;
 ...
 */
public class AssetUriLoader<Data> implements com.sdk.ads.glide.load.model.ModelLoader<Uri, Data> {
  ...
  public static class StreamFactory implements ModelLoaderFactory<Uri, InputStream>,
    ...
    @NonNull
    @Override
    public com.sdk.ads.glide.load.model.ModelLoader<Uri, InputStream> build(MultiModelLoaderFactory multiFactory) {
