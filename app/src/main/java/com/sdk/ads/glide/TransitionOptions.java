...
import com.sdk.ads.glide.request.transition.NoTransition;
import com.sdk.ads.glide.request.transition.TransitionFactory;
import com.sdk.ads.glide.request.transition.ViewAnimationFactory;
import com.sdk.ads.glide.request.transition.ViewPropertyAnimationFactory;
import com.sdk.ads.glide.request.transition.ViewPropertyTransition;
...
public abstract class TransitionOptions<CHILD extends TransitionOptions<CHILD, TranscodeType>,
   ...
   *
   * @param animator The {@link com.sdk.ads.glide.request.transition.ViewPropertyTransition
   *                 .Animator} to run.
   * @return This request builder.
   */
  @NonNull
   ...
   * {@link com.sdk.ads.glide.request.transition.Transition} for each request started with these
