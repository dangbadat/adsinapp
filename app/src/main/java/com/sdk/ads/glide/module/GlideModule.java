 ...
 * {@link com.sdk.ads.glide.GlideBuilder} and registering
 * {@link com.sdk.ads.glide.load.model.ModelLoader ModelLoaders}.
 *
 * <p> To use this interface: <ol> <li> Implement the GlideModule interface in a class with public
 * visibility, calling
 * {@link Registry#prepend(Class, Class, com.sdk.ads.glide.load.ResourceDecoder)} for each
 * {@link com.sdk.ads.glide.load.model.ModelLoader} you'd like to register:
 * <pre>
 *                  <code>
 ...
 * <pre>
 *                  {@code
 *                      -keepnames class * com.sdk.ads.glide.samples.flickr.FlickrGlideModule
 *                  }
 *              </pre>
 ...
 *                 {@code
 *                      <meta-data
 *                          android:name="com.sdk.ads.glide.samples.flickr.FlickrGlideModule"
