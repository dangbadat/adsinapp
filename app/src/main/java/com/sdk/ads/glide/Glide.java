...
import com.sdk.ads.glide.load.ImageHeaderParser;
import com.sdk.ads.glide.load.ResourceDecoder;
import com.sdk.ads.glide.load.data.InputStreamRewinder;
import com.sdk.ads.glide.load.engine.Engine;
import com.sdk.ads.glide.load.engine.bitmap_recycle.ArrayPool;
import com.sdk.ads.glide.load.engine.bitmap_recycle.BitmapPool;
import com.sdk.ads.glide.load.engine.cache.MemoryCache;
import com.sdk.ads.glide.load.engine.prefill.BitmapPreFiller;
import com.sdk.ads.glide.load.engine.prefill.PreFillType;
import com.sdk.ads.glide.load.model.AssetUriLoader;
import com.sdk.ads.glide.load.model.ByteArrayLoader;
import com.sdk.ads.glide.load.model.ByteBufferEncoder;
import com.sdk.ads.glide.load.model.ByteBufferFileLoader;
import com.sdk.ads.glide.load.model.DataUrlLoader;
import com.sdk.ads.glide.load.model.FileLoader;
import com.sdk.ads.glide.load.model.GlideUrl;
import com.sdk.ads.glide.load.model.MediaStoreFileLoader;
import com.sdk.ads.glide.load.model.ResourceLoader;
import com.sdk.ads.glide.load.model.StreamEncoder;
import com.sdk.ads.glide.load.model.StringLoader;
import com.sdk.ads.glide.load.model.UnitModelLoader;
import com.sdk.ads.glide.load.model.UriLoader;
import com.sdk.ads.glide.load.model.UrlUriLoader;
import com.sdk.ads.glide.load.model.stream.HttpGlideUrlLoader;
import com.sdk.ads.glide.load.model.stream.HttpUriLoader;
import com.sdk.ads.glide.load.model.stream.MediaStoreImageThumbLoader;
import com.sdk.ads.glide.load.model.stream.MediaStoreVideoThumbLoader;
import com.sdk.ads.glide.load.model.stream.UrlLoader;
import com.sdk.ads.glide.load.resource.bitmap.BitmapDrawableDecoder;
import com.sdk.ads.glide.load.resource.bitmap.BitmapDrawableEncoder;
import com.sdk.ads.glide.load.resource.bitmap.BitmapEncoder;
import com.sdk.ads.glide.load.resource.bitmap.ByteBufferBitmapDecoder;
import com.sdk.ads.glide.load.resource.bitmap.DefaultImageHeaderParser;
import com.sdk.ads.glide.load.resource.bitmap.Downsampler;
import com.sdk.ads.glide.load.resource.bitmap.ExifInterfaceImageHeaderParser;
import com.sdk.ads.glide.load.resource.bitmap.ResourceBitmapDecoder;
import com.sdk.ads.glide.load.resource.bitmap.StreamBitmapDecoder;
import com.sdk.ads.glide.load.resource.bitmap.UnitBitmapDecoder;
import com.sdk.ads.glide.load.resource.bitmap.VideoDecoder;
import com.sdk.ads.glide.load.resource.bytes.ByteBufferRewinder;
import com.sdk.ads.glide.load.resource.drawable.ResourceDrawableDecoder;
import com.sdk.ads.glide.load.resource.drawable.UnitDrawableDecoder;
import com.sdk.ads.glide.load.resource.file.FileDecoder;
import com.sdk.ads.glide.load.resource.transcode.BitmapBytesTranscoder;
import com.sdk.ads.glide.load.resource.transcode.BitmapDrawableTranscoder;
import com.sdk.ads.glide.load.resource.transcode.DrawableBytesTranscoder;
import com.sdk.ads.glide.manager.ConnectivityMonitorFactory;
import com.sdk.ads.glide.manager.RequestManagerRetriever;
import com.sdk.ads.glide.module.ManifestParser;
import com.sdk.ads.glide.request.RequestListener;
import com.sdk.ads.glide.request.RequestOptions;
import com.sdk.ads.glide.request.target.ImageViewTargetFactory;
 ...
 * {@link com.sdk.ads.glide.load.engine.cache.DiskCache} and {@link MemoryCache}.
 */
public class Glide implements ComponentCallbacks2 {
    ...
    private static void initializeGlide(@NonNull Context context, @NonNull GlideBuilder builder) {
        ...
        List<com.sdk.ads.glide.module.GlideModule> manifestModules = Collections.emptyList();
        ...
        if (annotationGeneratedModule != null
            ...
            Iterator<com.sdk.ads.glide.module.GlideModule> iterator = manifestModules.iterator();
            while (iterator.hasNext()) {
                com.sdk.ads.glide.module.GlideModule current = iterator.next();
        ...
        if (Log.isLoggable(TAG, Log.DEBUG)) {
            for (com.sdk.ads.glide.module.GlideModule glideModule : manifestModules) {
        ...
        for (com.sdk.ads.glide.module.GlideModule module : manifestModules) {
        ...
        try {
            Class<GeneratedAppGlideModule> clazz =
                    (Class<GeneratedAppGlideModule>)
                            Class.forName("com.sdk.ads.glide.GeneratedAppGlideModuleImpl");
     ...
     * {@link com.sdk.ads.glide.load.Transformation}s. Use outside of these classes is not generally
     * recommended. </p>
     */
    @NonNull
