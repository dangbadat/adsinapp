...
import com.sdk.ads.glide.Registry.NoModelLoaderAvailableException;
...
/**
 * Capable of building an {@link com.sdk.ads.glide.load.model.ModelLoader} that wraps one or more other {@link com.sdk.ads.glide.load.model.ModelLoader}s for
...
public class MultiModelLoaderFactory {
  ...
  private static final com.sdk.ads.glide.load.model.ModelLoader<Object, Object> EMPTY_MODEL_LOADER = new EmptyModelLoader();
  ...
  synchronized <Model, Data> void append(
      ...
      @NonNull com.sdk.ads.glide.load.model.ModelLoaderFactory<? extends Model, ? extends Data> factory) {
  ...
  @NonNull
  synchronized <Model, Data> List<com.sdk.ads.glide.load.model.ModelLoaderFactory<? extends Model, ? extends Data>> replace(
      @NonNull Class<Model> modelClass,
      @NonNull Class<Data> dataClass,
      @NonNull com.sdk.ads.glide.load.model.ModelLoaderFactory<? extends Model, ? extends Data> factory) {
    List<com.sdk.ads.glide.load.model.ModelLoaderFactory<? extends Model, ? extends Data>> removed =
  ...
  @NonNull
  synchronized <Model, Data> List<com.sdk.ads.glide.load.model.ModelLoaderFactory<? extends Model, ? extends Data>> remove(
      @NonNull Class<Model> modelClass,
      @NonNull Class<Data> dataClass) {
    List<com.sdk.ads.glide.load.model.ModelLoaderFactory<? extends Model, ? extends Data>> factories = new ArrayList<>();
  ...
  @NonNull
  synchronized <Model> List<com.sdk.ads.glide.load.model.ModelLoader<Model, ?>> build(@NonNull Class<Model> modelClass) {
    try {
      List<com.sdk.ads.glide.load.model.ModelLoader<Model, ?>> loaders = new ArrayList<>();
  ...
  @NonNull
  public synchronized <Model, Data> com.sdk.ads.glide.load.model.ModelLoader<Model, Data> build(@NonNull Class<Model> modelClass,
                                                                                                 @NonNull Class<Data> dataClass) {
    try {
      List<com.sdk.ads.glide.load.model.ModelLoader<Model, Data>> loaders = new ArrayList<>();
  ...
  private <Model, Data> com.sdk.ads.glide.load.model.ModelLoaderFactory<Model, Data> getFactory(@NonNull Entry<?, ?> entry) {
    return (com.sdk.ads.glide.load.model.ModelLoaderFactory<Model, Data>) entry.factory;
  }

  @NonNull
  @SuppressWarnings("unchecked")
  private <Model, Data> com.sdk.ads.glide.load.model.ModelLoader<Model, Data> build(@NonNull Entry<?, ?> entry) {
    return (com.sdk.ads.glide.load.model.ModelLoader<Model, Data>) Preconditions.checkNotNull(entry.factory.build(this));
  }

  @NonNull
  @SuppressWarnings("unchecked")
  private static <Model, Data> com.sdk.ads.glide.load.model.ModelLoader<Model, Data> emptyModelLoader() {
    return (com.sdk.ads.glide.load.model.ModelLoader<Model, Data>) EMPTY_MODEL_LOADER;
  }

  private static class Entry<Model, Data> {
    private final Class<Model> modelClass;
    @Synthetic final Class<Data> dataClass;
    @Synthetic final com.sdk.ads.glide.load.model.ModelLoaderFactory<? extends Model, ? extends Data> factory;
  ...
  static class Factory {
    ...
    public <Model, Data> MultiModelLoader<Model, Data> build(
        @NonNull List<com.sdk.ads.glide.load.model.ModelLoader<Model, Data>> modelLoaders,
