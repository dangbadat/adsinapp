 ...
 */
public final class MediaStoreFileLoader implements com.sdk.ads.glide.load.model.ModelLoader<Uri, File> {
  ...
  /**
   * {@link com.sdk.ads.glide.load.model.ModelLoaderFactory} for {@link MediaStoreFileLoader}s.
   */
