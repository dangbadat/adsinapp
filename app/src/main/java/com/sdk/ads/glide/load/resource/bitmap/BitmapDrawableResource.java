...
import com.sdk.ads.glide.load.engine.Initializable;
import com.sdk.ads.glide.load.engine.bitmap_recycle.BitmapPool;
import com.sdk.ads.glide.load.resource.drawable.DrawableResource;
import com.sdk.ads.glide.util.Util;

/**
 * A {@link com.sdk.ads.glide.load.engine.Resource} that wraps an
 * {@link BitmapDrawable}
 *
