...
import com.sdk.ads.glide.manager.ActivityFragmentLifecycle;
 ...
 *
 * @see com.sdk.ads.glide.manager.RequestManagerFragment
 * @see com.sdk.ads.glide.manager.RequestManagerRetriever
 * @see RequestManager
 */
public class SupportRequestManagerFragment extends Fragment {
  private static final String TAG = "SupportRMFragment";
  private final com.sdk.ads.glide.manager.ActivityFragmentLifecycle lifecycle;
  private final com.sdk.ads.glide.manager.RequestManagerTreeNode requestManagerTreeNode =
  ...
  public SupportRequestManagerFragment() {
    this(new com.sdk.ads.glide.manager.ActivityFragmentLifecycle());
  }

  @VisibleForTesting
  @SuppressLint("ValidFragment")
  public SupportRequestManagerFragment(@NonNull com.sdk.ads.glide.manager.ActivityFragmentLifecycle lifecycle) {
  ...
  @NonNull
  com.sdk.ads.glide.manager.ActivityFragmentLifecycle getGlideLifecycle() {
    return lifecycle;
  }
  ...
  /**
   * Returns the {@link com.sdk.ads.glide.manager.RequestManagerTreeNode} that provides tree traversal methods relative
   * to the
   * associated {@link RequestManager}.
   */
  @NonNull
  public com.sdk.ads.glide.manager.RequestManagerTreeNode getRequestManagerTreeNode() {
