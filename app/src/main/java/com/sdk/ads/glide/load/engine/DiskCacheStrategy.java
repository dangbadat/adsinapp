...
public abstract class DiskCacheStrategy {
   ...
   * {@link com.sdk.ads.glide.load.data.DataFetcher} and the
   * {@link com.sdk.ads.glide.load.EncodeStrategy} of the
   * {@link com.sdk.ads.glide.load.ResourceEncoder} (if an
   * {@link com.sdk.ads.glide.load.ResourceEncoder} is available).
   */
   ...
   * com.sdk.ads.glide.load.ResourceEncoder} will use to encode the resource.
   */
