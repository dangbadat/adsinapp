...
import static com.sdk.ads.glide.request.RequestOptions.diskCacheStrategyOf;
import static com.sdk.ads.glide.request.RequestOptions.signatureOf;
import static com.sdk.ads.glide.request.RequestOptions.skipMemoryCacheOf;
...
import com.sdk.ads.glide.load.engine.DiskCacheStrategy;
import com.sdk.ads.glide.request.BaseRequestOptions;
import com.sdk.ads.glide.request.ErrorRequestCoordinator;
import com.sdk.ads.glide.request.FutureTarget;
import com.sdk.ads.glide.request.Request;
import com.sdk.ads.glide.request.RequestCoordinator;
import com.sdk.ads.glide.request.RequestFutureTarget;
import com.sdk.ads.glide.request.RequestListener;
import com.sdk.ads.glide.request.RequestOptions;
import com.sdk.ads.glide.request.SingleRequest;
import com.sdk.ads.glide.request.ThumbnailRequestCoordinator;
import com.sdk.ads.glide.request.target.PreloadTarget;
import com.sdk.ads.glide.request.target.Target;
import com.sdk.ads.glide.request.target.ViewTarget;
import com.sdk.ads.glide.signature.ApplicationVersionSignature;
import com.sdk.ads.glide.util.Executors;
...
public class RequestBuilder<TranscodeType> extends BaseRequestOptions<RequestBuilder<TranscodeType>>
  ...
  protected static final RequestOptions DOWNLOAD_ONLY_OPTIONS =
      new RequestOptions().diskCacheStrategy(DiskCacheStrategy.DATA).priority(com.sdk.ads.glide.Priority.LOW)
          .skipMemoryCache(true);

  private final Context context;
  private final RequestManager requestManager;
  private final Class<TranscodeType> transcodeClass;
  private final com.sdk.ads.glide.Glide glide;
   ...
   * com.sdk.ads.glide.load.model.ModelLoader}, {@link com.sdk.ads.glide.load.ResourceDecoder},
   * and {@link Transformation}s. However,
   * {@link com.sdk.ads.glide.request.RequestOptions#placeholder(int)} and
   * {@link com.sdk.ads.glide.request.RequestOptions#error(int)}, and
   ...
   * {@link com.sdk.ads.glide.load.model.ModelLoader} or
   * {@link com.sdk.ads.glide.load.ResourceDecoder} instead of using this method.
   *
   ...
   * {@link com.sdk.ads.glide.request.RequestOptions#signature(com.sdk.ads.glide.load.Key)} to
   ...
   * {@link com.sdk.ads.glide.request.RequestOptions#skipMemoryCache(boolean)} may be
   * appropriate.
   * </p>
   *
   * @see #load(Object)
   ...
   * {@link com.sdk.ads.glide.load.model.UriLoader}.
   */
  @NonNull
  @Override
  @CheckResult
   ...
   * {@link com.sdk.ads.glide.request.RequestOptions#signature(com.sdk.ads.glide.load.Key)}
   ...
   * {@link com.sdk.ads.glide.load.model.ModelLoaderFactory} currently registered or
   * {@link Integer} to load the image represented by the given {@link Integer} resource id.
   * Defaults to {@link com.sdk.ads.glide.load.model.ResourceLoader} to load resource id models.
   *
   ...
   * transformed (other than {@link com.sdk.ads.glide.load.resource.gif.GifDrawable}). To avoid
   ...
   *               overridden by
   *               {@link com.sdk.ads.glide.request.RequestOptions#override(int, int)} if
   *               previously called.
   ...
   * @see com.sdk.ads.glide.ListPreloader
   */
  @NonNull
  ...
  @NonNull
  private com.sdk.ads.glide.Priority getThumbnailPriority(@NonNull com.sdk.ads.glide.Priority current) {
    switch (current) {
      case LOW:
        return com.sdk.ads.glide.Priority.NORMAL;
      case NORMAL:
        return com.sdk.ads.glide.Priority.HIGH;
      case HIGH:
      case IMMEDIATE:
        return com.sdk.ads.glide.Priority.IMMEDIATE;
      default:
  ...
  private Request buildRequestRecursive(
      ...
      com.sdk.ads.glide.Priority priority,
      int overrideWidth,
      int overrideHeight,
      BaseRequestOptions<?> requestOptions,
      Executor callbackExecutor) {
  ...
  private Request buildThumbnailRequestRecursive(
    ...
    if (thumbnailBuilder != null) {
      ...
      com.sdk.ads.glide.Priority thumbPriority = thumbnailBuilder.isPrioritySet()
