...
import com.sdk.ads.glide.util.LogTime;
import com.sdk.ads.glide.util.Synthetic;
import com.sdk.ads.glide.util.pool.FactoryPools.Poolable;
import com.sdk.ads.glide.util.pool.GlideTrace;
import com.sdk.ads.glide.util.pool.StateVerifier;
...
class DecodeJob<R> implements DataFetcherGenerator.FetcherReadyCallback,
  ...
  private void notifyComplete(com.sdk.ads.glide.load.engine.Resource<R> resource, DataSource dataSource) {
    setNotifiedOrThrow();
  ...
  private void decodeFromRetrievedData() {
    ...
    com.sdk.ads.glide.load.engine.Resource<R> resource = null;
    try {
  ...
  private void notifyEncodeAndRelease(com.sdk.ads.glide.load.engine.Resource<R> resource, DataSource dataSource) {
    if (resource instanceof Initializable) {
      ((Initializable) resource).initialize();
    }

    com.sdk.ads.glide.load.engine.Resource<R> result = resource;
  ...
  private <Data> com.sdk.ads.glide.load.engine.Resource<R> decodeFromData(DataFetcher<?> fetcher, Data data,
    ...
    try {
      ...
      com.sdk.ads.glide.load.engine.Resource<R> result = decodeFromFetcher(data, dataSource);
      if (Log.isLoggable(TAG, Log.VERBOSE)) {
  ...
  private <Data> com.sdk.ads.glide.load.engine.Resource<R> decodeFromFetcher(Data data, DataSource dataSource)
  ...
  private <Data, ResourceType> com.sdk.ads.glide.load.engine.Resource<R> runLoadPath(Data data, DataSource dataSource,
  ...
  @Synthetic
  @NonNull
  <Z> com.sdk.ads.glide.load.engine.Resource<Z> onResourceDecoded(DataSource dataSource,
                                                                   @NonNull com.sdk.ads.glide.load.engine.Resource<Z> decoded) {
    @SuppressWarnings("unchecked")
    Class<Z> resourceSubClass = (Class<Z>) decoded.get().getClass();
    Transformation<Z> appliedTransformation = null;
    com.sdk.ads.glide.load.engine.Resource<Z> transformed = decoded;
    ...
    com.sdk.ads.glide.load.engine.Resource<Z> result = transformed;
  ...
  private final class DecodeCallback<Z> implements DecodePath.DecodeCallback<Z> {
    ...
    @NonNull
    @Override
    public com.sdk.ads.glide.load.engine.Resource<Z> onResourceDecoded(@NonNull com.sdk.ads.glide.load.engine.Resource<Z> decoded) {
